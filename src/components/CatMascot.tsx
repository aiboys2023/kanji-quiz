...
/** Simple sticker-style cat SVG — expressions via eyes / mouth / accessories */
export default function CatMascot({
  ...
  return (
    <svg
      ...
      aria-hidden
    >
      <ellipse cx="100" cy="120" rx="72" ry="62" fill="#FFECD2" stroke="#1a1a2e" strokeWidth="3" />
      <path
      ...
      />
      {superMode && (
        <ellipse cx="100" cy="55" rx="58" ry="14" fill="#1a1a2e" opacity="0.85" />
      )}
      <ellipse cx="78" cy="108" rx="10" ry="14" fill="#1a1a2e" />
      <ellipse cx="122" cy="108" rx="10" ry="14" fill="#1a1a2e" />
      {thinking && (
        <>
      ...
      {excited && !thinking && (
        <>
          <path d="M72 118 Q78 128 84 118" fill="none" stroke="#1a1a2e" strokeWidth="3" strokeLinecap="round" />
          <path d="M116 118 Q122 128 128 118" fill="none" stroke="#1a1a2e" strokeWidth="3" strokeLinecap="round" />
        </>
      )}
      {encourage && !thinking && (
        <path
